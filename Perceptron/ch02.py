...
plt.savefig('images/02_06_irisdata.png', dpi=300)
plt.show()
...
plt.savefig('images/02_07_training errors.png', dpi=300)
plt.show()
...
plt.savefig('images/02_08_ decision regions.png', dpi=300)
plt.show()
